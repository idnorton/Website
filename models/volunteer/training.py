...
class TrainingQuestion(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    training_id = db.Column(db.Integer, db.ForeignKey("volunteer_training.id"), nullable=False)
...
class TrainingAnswer(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    question_id = db.Column(db.Integer, db.ForeignKey("volunteer_training_question.id"), nullable=False)
    text = db.Column(db.String, nullable=False, default="")
